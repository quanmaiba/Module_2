...
namespace GameLol.Data.Migrations
{
    ...
    partial class GameLolContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameLol.DoMain.RoleHero", b =>
                {
                    b.Property<int>("RoleHeroID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GameLol.DoMain.RoleSkinHero", b =>
                {
                    ...
                    b.HasKey("HeroID", "RoleHeroID");

                    b.HasIndex("RoleHeroID");

                    b.ToTable("RoleOfHeroes");
                });
            ...
            modelBuilder.Entity("GameLol.DoMain.RoleSkinHero", b =>
                {
                    ...
                    b.HasOne("GameLol.DoMain.RoleHero", "RoleHero")
                        .WithMany("RoleSkinHero")
                        .HasForeignKey("RoleHeroID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
