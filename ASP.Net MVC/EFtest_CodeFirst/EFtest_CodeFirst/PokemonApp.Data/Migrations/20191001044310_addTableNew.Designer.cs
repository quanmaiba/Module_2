...
namespace PokemonApp.Data.Migrations
{
    ...
    [Migration("20191001044310_addTableNew")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonApp.Domain.SecretDentity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PokemonApp.Domain.SecretDentity", b =>
                {
                    b.HasOne("PokemonApp.Domain.Pokemon")
                        .WithOne("SecretDentity")
                        .HasForeignKey("PokemonApp.Domain.SecretDentity", "PokemonId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
